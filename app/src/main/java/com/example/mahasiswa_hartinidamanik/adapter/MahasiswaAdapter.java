package com.example.mahasiswa_hartinidamanik.adapter;
...
import com.example.mahasiswa_hartinidamanik.ListMahasiswaActivity;
import com.example.mahasiswa_hartinidamanik.R;
import com.example.mahasiswa_hartinidamanik.UpdateActivity;
...
public class MahasiswaAdapter extends
        RecyclerView.Adapter<MahasiswaAdapter.StudentViewHolder>{
    ...
    public StudentViewHolder onCreateViewHolder(@NonNull ViewGroup parent,
                                                int viewType) {
        View view =
                LayoutInflater.from(parent.getContext()).inflate(R.layout.item_mahasiswa,
                        parent, false);
